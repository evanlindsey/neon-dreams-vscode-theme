...
- `themes/neon-dreams-dark-color-theme.json` - the dark color theme definition file.
- `themes/neon-dreams-light-color-theme.json` - the light color theme definition file.
